...
(timing in \S\ref{sec:evaluation}, distinct from the per-module JIT
compile time of \S\ref{sec:perf}). Comparison with the CAV 2023 rule
set of Albert et al.~\cite{verified_evm_cav23} appears in
\S\ref{sec:related}.
