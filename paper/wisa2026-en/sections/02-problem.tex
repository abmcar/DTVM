...
\S\ref{sec:evaluation}---specifically the leftmost cluster
``U256-heavy (1--11)'' in Figure~\ref{fig:speedup}, with the
per-benchmark distribution shown in
Table~\ref{tab:family-attribution}). The share
