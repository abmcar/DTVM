...
cluster in Figure~\ref{fig:speedup}). The share
...
Despite its small share, the chain is still worth optimizing: on
U256-heavy workloads, rule hit rates reach 25--99.9\%, with a very
...
Figure~\ref{fig:architecture} sketches how offline rule production and
admission feed into the JIT runtime, and how the matched differential
suite gates correctness.
