...
We first define dMIR's bit-vector semantics, then describe enumeration
and SMT admission, and finally summarize the two-tier rule organization.
The JIT runs a compiled two-tier implementation: dMIR for algebraic
rewrites and x86 CgIR (code-generation IR) for carry-chain cleanup.
