...
\begin{tikzpicture}[
  ...
  carry/.style={-{Latex[length=1.8mm]}, semithick, dashed},
  carrylab/.style={font=\scriptsize\itshape\rmfamily, inner sep=1pt},
]
...
\end{tikzpicture}
\caption{U256 4-limb addition in dMIR (left) and x86-64 (right). Each
\texttt{ADC} lowers 1:1 to \texttt{adc}; dashed arrows trace the serial
carry chain $c_0, c_1, c_2$ that the lowering preserves.}
