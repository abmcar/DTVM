...
\begin{table}[t]
\centering
\caption{Results on four differential test categories for the enabled
side (83 new rules) and the baseline side (upstream main): passes/total.
Identical numbers in both columns indicate that the enabled rule set
